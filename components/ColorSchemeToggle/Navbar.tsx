    ...
    <nav style={styles.navbar}>
      <ul style={styles.navList}>
        ...
        <li style={styles.navItem}>
          <Link href="/home" style={styles.link} passHref>
            <svg
        ...
        <li style={styles.navItem}>
          <Link href="/about" style={styles.link} passHref>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="50"
              height="50"
        ...
        <li style={styles.navItem}>
          <Link href="/contact" style={styles.link} passHref>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="50"
              height="50"
